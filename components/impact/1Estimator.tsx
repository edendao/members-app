import { Box, Button, Flex, Heading, Link, Progress, Stack, Text, VStack } from "@chakra-ui/react"
...
export const Estimator: React.FC<{ next: () => void }> = ({ next }) => {
    ...
    <VStack spacing={8} p={[4, null, 8]}>
      ...
      {txs.length !== 0 && (
        <Stack direction={["column", null, "row"]} align="center" justify="space-evenly" w="100%">
          <Box color="white" animation="pulser 10s ease-in-out" textAlign="center">
